...
<div id="title-carousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
	<!-- The slideshow -->
	<div class="carousel-inner">
	  <div class="carousel-item active"><img src="media/background/bg2.jpg" alt="background-image"></div>
		<div class="carousel-item"><img src="media/background/bg1.jpg" alt="background-image"></div>
		<div class="carousel-item"><img src="media/background/bg6.jpg" alt="background-image"></div>
		<div class="carousel-item"><img src="media/background/bg12.jpg" alt="background-image"></div>
	</div>
...
<div class="container" style="margin-bottom: 60px; margin-top: 60px;">
	<!-- page title -->
	<h1 style="font-size: 5em; font-family: 'DM Serif Text', serif;">JB's</h1>
	<h4 style="text-transform: uppercase; font-family: 'DM Serif Text', serif;">
		Electrical<br>Contractors Ltd</h2>
	<br><br><br>
	<h2 style="font-size: 2.3em;">Trusted by Rotorua for premium results</h2>
	<br><br>
	<!-- about us -->
	JB’s Electrical Ltd was founded in 1987.<br><br>
	Bruce Smith and his team have earned a reputation for providing
	professional, honest and reliable service.
	<br><br>
	We use excellent materials and our team are switched on, hard working individuals.
	Our electrical inspector ensures work is completed to the highest standard.
</div> 
...
<div class="row">
	...
	<!-- contact info -->
	<div class="col-md-6 flex-container-center content-item">
		<h3 class="heading">
			<a href="contact.php" class="link-padding">Contact us</a>
		</h3>
		<p class="content-text">
